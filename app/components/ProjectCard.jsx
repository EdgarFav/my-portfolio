...
const ProjectCard = ({ imgUrl, title, description, githubUrl, previewUrl, stack }) => {
    return (
        <div>
            ...
            >
                <div className='overlay items-center justify-center absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500'>
                    <Link href={githubUrl} target="_blank" className='h-14 w-14 mr-2 border-2 relative rounded-full border-[#ADB7BE] hover:border-white group/link'>
            ...
            <div className='text-white rounded-b-xl mt-3 bg-[#181818] py-6 px-4'>
                ...
                <h5 className='text-xl font-semibold mt-2'>Tech Stack</h5>
                <p className='text-[#ADB7BE]'>{stack}</p>
            </div>
        </div>
    )
}
