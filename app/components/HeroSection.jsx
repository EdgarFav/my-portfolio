            ...
            <div className='grid grid-cols-1 lg:grid-cols-12'>
                <motion.div
                    ...
                    <h1 className='mb-4 text-4xl sm-text-5xl lg:text-6xl font-extrabold'>
                        <span className='text-transparent bg-clip-text bg-gradient-to-t from-purple-400 to-blue-600'>Hello, I am{" "}</span>
                        <br></br>
                        <TypeAnimation
                            sequence={[
                                'Nahú',
                    ...
                    <div>
                        ...
                        <button className='px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 hover:bg-slate-800 text-white mt-3'>
                            <a href="https://drive.google.com/file/d/1FfcsMsKAVd4rT48WUAjcqY7lza6xzvT4/view?usp=sharing" target='_blank' download="EdgarFavela-CV"><span className='block bg-[#121212] hover:bg-slate-800 rounded-full px-5 py-2'>Download CV</span></a>
                        </button>
                    </div>
                </motion.div>
                {/* <motion.div
