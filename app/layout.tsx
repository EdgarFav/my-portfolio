...
const SITE_URL =
  process.env.NEXT_PUBLIC_SITE_URL || "https://www.nahucodes.dev";
const SITE_NAME = "Edgar Favela | Fullstack Developer";
const SITE_DESCRIPTION =
  "Desarrollador Fullstack con experiencia en React, Next.js, Node.js y más. Echa un vistazo a mis proyectos y habilidades técnicas.";
